...
/**
* Accessor class generated by script for packet type {@link PacketType.Play.Client#LOOK}
* Some types in getters and setters may not be supported properly yet.
*/
public final class Look extends PacketAccessor {
    public Look(Object handle) {
        super(PacketType.Play.Client.LOOK, handle);
    }
