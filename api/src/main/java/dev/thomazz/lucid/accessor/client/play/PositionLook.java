...
/**
* Accessor class generated by script for packet type {@link PacketType.Play.Client#POSITION_LOOK}
* Some types in getters and setters may not be supported properly yet.
*/
public final class PositionLook extends PacketAccessor {
    public PositionLook(Object handle) {
        super(PacketType.Play.Client.POSITION_LOOK, handle);
    }
