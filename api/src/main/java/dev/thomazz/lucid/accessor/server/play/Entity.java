...
/**
* Accessor class generated by script for packet type {@link PacketType.Play.Server#ENTITY}
* Some types in getters and setters may not be supported properly yet.
*/
public final class Entity extends PacketAccessor {
    public Entity(Object handle) {
        super(PacketType.Play.Server.ENTITY, handle);
    }

    public Entity() {
        super(PacketType.Play.Server.ENTITY);
    }
