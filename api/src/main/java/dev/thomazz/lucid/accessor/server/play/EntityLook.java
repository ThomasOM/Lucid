...
/**
* Accessor class generated by script for packet type {@link PacketType.Play.Server#ENTITY_LOOK}
* Some types in getters and setters may not be supported properly yet.
*/
public final class EntityLook extends PacketAccessor {
    public EntityLook(Object handle) {
        super(PacketType.Play.Server.ENTITY_LOOK, handle);
    }
